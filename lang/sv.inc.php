...
$messages['nokeyphrase'] = "Kryptering av Token kräver en slumpmässig sträng keyphrase setting";
$messages['ldaperror'] = "Kan inte komma åt LDAPkatalogen";
$messages['loginrequired'] = "Du måste ange ditt användarnamn";
$messages['oldpasswordrequired'] = "Du måste ange ditt befintliga lösenord";
...
$messages['oldpassword'] = "Befintligt lösenord";
$messages['newpassword'] = "Nytt lösenord";
$messages['confirmpassword'] = "Bekräfta lösenordet";
...
$messages['sameasold'] = "Ditt nya lösenord är identisk med ditt befintliga lösenord";
...
$messages['policynoreuse'] = "Ditt nya lösenord får inte vara identiskt med ditt befintliga lösenord";
...
$messages['changehelp'] = "Ange ditt befintliga lösenord och ett nytt lösenord.";
...
$messages['sshkeyrequired'] = "SSH Key krävs";
...
$messages['changesshkeyhelp'] = "Ange ditt lösenord och ny SSH Key.";
$messages['sshkeyerror'] = "SSH Key avslogs av LDAP-katalogen";
$messages['pwned'] = "Ditt nya lösenord är listat som ett känt lösenord, om du använder lösenordet på andra tjänster så bör du byta där också";
$messages['policypwned'] = "Ditt nya lösenord är troligen inte listat som ett känt lösenord";
$messages['specialatends'] = "Ditt nya lösenord innehåller Specialtecken endast i början eller slutet";
$messages['policyspecialatends'] = "Ditt nya lösenord får inte innehålla Specialtecken endast i början eller slutet";
